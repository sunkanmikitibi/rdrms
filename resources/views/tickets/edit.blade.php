...
@section('content')
    <div class="card card-custom">
        <div class="card-header flex-wrap py-5">
            <div class="card-title">
                <h3 class="card-label">Tickets
                    <span class="text-muted pt-2 font-size-sm d-block"> Edit Tickets Sold</span>
                </h3>
            </div>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('ticket-sales.update', $ticket) }}" method="post">
                @csrf
                @method('PATCH')
                <div class="row">
                                ...
                                <select name="driver_id" class="form-control select2" id="kt_select2_2">
                                    ...
                                    @foreach ($drivers as $driver)
                                        <option value="{{ $driver->id }}"
                                            {{ $ticket->driver_id == $driver->id ? 'selected' : '' }}>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="number" value="{{ $ticket->amount }}" name="amount" class="form-control"
                                    id="">
                            </div>
                        </div>
                    </div>
