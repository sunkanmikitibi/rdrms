<div class="card card-custom">
    <div class="card-header flex-wrap py-5">
        <div class="card-title">
            <h3 class="card-label">Bikers List
                <span class="text-muted pt-2 font-size-sm d-block"> All Bike Drivers</span>
            </h3>
        </div>
            ...
            <tbody>
                @foreach ($bikers as $driver)
                    <tr>
                        ...
                        <td>{{ $driver->lga_id.'- 11 - '.$driver->tax_id }}</td>
