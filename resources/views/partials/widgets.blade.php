        ...
        <div class="col-xl-3">
            ...
            <div class="card card-custom bg-light-success card-stretch gutter-b">
                ...
                <div class="card-body">
                    ...
                    <span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">{{ $drivers->count() }}</span>
                    <span class="font-weight-bold text-muted font-size-sm">Drivers</span>
                </div>
                <!--end::Body-->
            </div>
            <!--end::Stats Widget 25-->
        ...
        <div class="col-xl-3">
            ...
            <div class="card card-custom bg-light-info card-stretch gutter-b">
                ...
                <div class="card-body">
                    ...
                    <span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">{{ $bikers->count() }}</span>
                    <span class="font-weight-bold text-muted font-size-sm">Riders</span>
                </div>
                <!--end::Body-->
            </div>
            <!--end::Stats Widget 27-->
        ...
        <div class="col-xl-3">
            ...
            <div class="card card-custom bg-light-warning card-stretch gutter-b">
                ...
                <div class="card-body">
                    ...
                    <span class="card-title font-weight-bolder text-dark-75 font-size-h2 mb-0 mt-6 d-block">{{ number_format($ticket_total, 2) }}</span>
                    <span class="font-weight-bold text-muted font-size-sm">Ticket Sales</span>
                </div>
                <!--end::Body-->
            </div>
            <!--end::Stat: Widget 28-->
                    ...
                    <div class="flex-grow-1 p-8 card-rounded bgi-no-repeat d-flex align-items-center" style="background-color: #FFF4DE; background-position: left bottom; background-size: auto 100%; background-image: url(assets/media/svg/humans/custom-2.svg)">
                        <div class="row">
                            ...
                            <div class="col-12 col-xl-7">
                                <h4 class="text-danger font-weight-bolder">Welcome, {{ Auth::user()->name }}</h4>
